...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/iOSLearningMaterials/iOSDesignPattern.git", :tag => s.version.to_s }
  ...
  s.source_files  = "DesignPattern/DesignPattern/**/*.{h,m,swift}"
